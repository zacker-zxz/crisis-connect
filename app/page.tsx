...
export default function Home() {
  ...
  return (
    <div className="relative">
      ...
      {/* Two-Sided Ecosystem – Full Screen */}
      <section id="how-it-works" className="min-h-screen flex items-center py-24 px-4 relative bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-slate-800 mb-6">The Two-Sided Ecosystem</h2>
            <p className="text-xl text-slate-500 max-w-2xl mx-auto">A seamless platform catering to organizations that need help and individuals ready to give it.</p>
          </motion.div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {reviews.map((review, i) => (
              ...
              >
                <MessageSquare className="absolute top-6 right-6 text-slate-200 w-12 h-12" />
                ...
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center font-bold text-lg text-white">
                    {review.name[0]}
                  </div>
                  <div>
        ...
        <div className="container mx-auto max-w-4xl glass-card rounded-3xl p-8 md:p-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-slate-500 mb-8">Have questions about integrating your NGO or partnering with us? Reach out today.</p>
            ...
            <form className="space-y-4">
              <input type="text" placeholder="Name" className="w-full bg-white border border-gray-200 rounded-xl p-4 text-slate-800 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/20 transition placeholder:text-slate-400" />
              <input type="email" placeholder="Email" className="w-full bg-white border border-gray-200 rounded-xl p-4 text-slate-800 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/20 transition placeholder:text-slate-400" />
              <textarea placeholder="Message" rows={4} className="w-full bg-white border border-gray-200 rounded-xl p-4 text-slate-800 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/20 transition resize-none placeholder:text-slate-400"></textarea>
              <button type="button" className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-4 rounded-xl transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg">
                Send Message
              </button>
            </form>
          </div>
