...
export default function Footer() {
  return (
    <footer className="mt-auto bg-white border-t border-gray-200 pt-16 pb-8 text-slate-500 relative z-10 w-full">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <h3 className="text-slate-800 font-semibold mb-4 text-lg">For Volunteers</h3>
          ...
          <div>
            <h3 className="text-slate-800 font-semibold mb-4 text-lg">For NGOs</h3>
            <ul className="space-y-3 text-sm">
