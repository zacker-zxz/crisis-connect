        ...
        <div className="p-6 border-t border-white/5 space-y-4">
          <div className="flex items-center gap-3 p-2">
             ...
             <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-primary font-medium italic">Active Responder</p>
             </div>
          </div>
          <button 
        ...
        <header className="h-20 border-b border-white/5 bg-slate-900/50 backdrop-blur-md px-8 flex items-center justify-between z-30 shrink-0">
           <div className="flex items-center gap-4">
               ...
               <h1 className="text-xl font-bold tracking-tight text-white hidden md:block">
                  {navItems.find(i => i.href === pathname)?.name || 'Volunteer Console'}
               </h1>
           </div>
           ...
           <div className="flex items-center gap-6">
                ...
                <div className="hidden sm:flex flex-col items-end">
                    <p className="text-xs font-bold text-white uppercase tracking-widest opacity-50">Impact Score</p>
                    <p className="text-sm font-bold text-secondary flex items-center gap-2">
                        <Heart className="w-4 h-4 fill-secondary" /> 2,450
                    </p>
                </div>
           </div>
        </header>
