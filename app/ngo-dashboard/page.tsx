...
import { 
  ...
  ClipboardCheck, Zap, Flame, PlusCircle, ClipboardList
} from 'lucide-react';
...
export default function NgoDashboardMain() {
  ...
  const stats = [
    ...
    { label: 'Open Requirements', value: tasks.filter(t => t.status === 'Open').length,          icon: AlertTriangle,  color: 'text-orange-600', bg: 'bg-orange-50',     border: 'border-orange-200' },
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
        {stats.map((stat, i) => (
          <motion.div
            ...
            className="relative overflow-hidden bg-white border border-gray-200 p-6 rounded-[2rem] hover:shadow-lg transition-all group shadow-sm"
          >
            ...
            <div className={`w-11 h-11 rounded-xl ${stat.bg} border ${stat.border} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}>
